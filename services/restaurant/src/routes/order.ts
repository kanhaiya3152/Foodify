...
import { assignRiderToOrder, createOrder, fetchOrderForPayment, fetchRestaurantOrders, fetchSingleOrder, getCurrentOrderForRider, getMyOrders, getOrdersForRider, updateOrderStatus, updateOrderStatusRider } from "../controllers/order.js";
...
router.get("/history/rider", getOrdersForRider);
